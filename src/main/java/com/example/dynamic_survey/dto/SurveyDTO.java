...
public class SurveyDTO {
    ...
    @NotNull(message = "問卷開始日期不可為空") private LocalDate startDate;
    @NotNull(message = "問卷結束日期不可為空") private LocalDate endDate;
    @NotBlank(message = "問卷狀態不可為空") private String status; // DRAFT / PUBLISHED
